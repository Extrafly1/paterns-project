...
```bash
PS ...\lab_work_2> ruby main.rb
ID: 3542, Фамилия: Иванов, Имя: Иван, Отчество: Иванович, Телефон: +1 234-567-8901, Телеграм: , Почта: , Гит: https://github.com/ivan/repo.git
ID: 3559, Фамилия: Петров, Имя: Петр, Отчество: , Телефон: , Телеграм: , Почта: , Гит:
ID: 1666, Фамилия: Сидоров, Имя: Сидор, Отчество: Сидорович, Телефон: 1234567890, Телеграм: , Почта: , Гит:
ID: 3830, Фамилия: Кузнецов, Имя: Сергей, Отчество: , Телефон: , Телеграм: , Почта: , Гит: https://github.com/serezha/repo.git
```
