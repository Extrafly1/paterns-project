...
def countDivisorsNotDivisibleBy3(number)        # функция подсчета делителей
  count = 0
...
puts "Количество делителей числа, не делящихся на 3: #{countDivisorsNotDivisibleBy3(number)}"
